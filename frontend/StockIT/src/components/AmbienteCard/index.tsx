...
export function AmbienteCard({
  ...
  return (
    <div
      ...
      className="group relative bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg hover:-translate-y-2 hover:z-10 transition-all duration-300 cursor-pointer overflow-visible flex-shrink-0 w-60 flex flex-col"
    >
      {/* Hover overlay */}
