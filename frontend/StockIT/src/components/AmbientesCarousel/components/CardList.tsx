...
export function CardList({ ambientes, index, onEditar, onExcluir }: CardListProps) {
  return (
    <div className="overflow-hidden rounded-2xl mx-12" style={{ width: `${VISIBLE_CARDS * CARD_WIDTH - 20}px` }}>
      <div
